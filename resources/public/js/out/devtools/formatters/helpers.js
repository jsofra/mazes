...
var G__19990 = devtools.prefs.pref.call(null,v);
v = G__19990;
continue;
} else {
return v;
...
}catch (e19993){var _e__18973__auto__ = e19993;
return false;
}})();
...
}catch (e19997){var _e__18973__auto__ = e19997;
return false;
}})();
...
}catch (e19999){var _e__18973__auto__ = e19999;
return false;
}}
}
});
...
var vec__20001 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20001,(0),null);
var name = cljs.core.nth.call(null,vec__20001,(1),null);
...
return cljs.core.some.call(null,(function (p1__20004_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20004_SHARP_);
}),template);
});
...
var temp__5733__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__5733__auto__)){
