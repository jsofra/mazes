...
var temp__5733__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
...
var file = cljs.core.get.call(null,map__22594__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22594__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22594__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e22593){var _e = e22593;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___22596 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___22596)){
var seen_errors_22597 = temp__5733__auto___22596;
if(cljs.core.truth_(seen_errors_22597.has(self))){
} else {
seen_errors_22597.add(self);

var temp__5735__auto___22598 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___22598)){
var sense_22599 = temp__5735__auto___22598;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22599)].join('');
} else {
}
}
} else {
...
var temp__5735__auto__ = devtools.hints.error_object_sense.call(null,error);
