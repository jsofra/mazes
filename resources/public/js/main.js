var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=a15f83&fwbuild=build"};
...
document.write('<script>goog.require("jsofra.lsystems");</script>');
