...
var o19885 = temp__5733__auto__;
var temp__5733__auto____$1 = (o19885["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o19886 = temp__5733__auto____$1;
return (o19886["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18966__auto__ = f;
return (o__18966__auto__["toString"]).call(o__18966__auto__);
} else {
return "";
}
}catch (e19887){var _ = e19887;
return "";
}});
...
try{var o__18966__auto___19889 = t;
(o__18966__auto___19889["cljs$lang$ctorPrWriter"]).call(o__18966__auto___19889,t,writer);
}catch (e19888){var __19890 = e19888;
}
...
var char_code = (function (){var o__18966__auto__ = (new String(char$));
return (o__18966__auto__["charCodeAt"]).call(o__18966__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18966__auto__ = String;
return (o__18966__auto__["fromCharCode"]).call(o__18966__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19891 = num_code;
switch (G__19891) {
case (1):
return (185);
...
var o__18966__auto__ = String;
return (o__18966__auto__["fromCharCode"]).call(o__18966__auto__,superscript_code);
});
/**
...
var temp__5733__auto__ = cljs.core.second.call(null,cljs.core.re_find.call(null,/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5733__auto__)){
var meat = temp__5733__auto__;
var temp__5733__auto____$1 = cljs.core.re_find.call(null,/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5733__auto____$1)){
...
}catch (e19893){var _e__18973__auto__ = e19893;
return false;
}})())){
...
var vec__19894 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19894,(0),null);
...
var or__4131__auto__ = (function (){var temp__5733__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5733__auto__)){
...
var temp__5733__auto__ = (function (){var temp__5733__auto__ = (devtools.munging.get_global_scope.call(null)["goog"]);
if(cljs.core.truth_(temp__5733__auto__)){
var o19897 = temp__5733__auto__;
var temp__5733__auto____$1 = (o19897["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o19898 = temp__5733__auto____$1;
return (o19898["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___19905 = arguments.length;
var i__4731__auto___19906 = (0);
while(true){
if((i__4731__auto___19906 < len__4730__auto___19905)){
args__4736__auto__.push((arguments[i__4731__auto___19906]));

var G__19907 = (i__4731__auto___19906 + (1));
i__4731__auto___19906 = G__19907;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19901){
var vec__19902 = p__19901;
var ns_detector = cljs.core.nth.call(null,vec__19902,(0),null);
...
var G__19908 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19909 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19908;
remaining_tokens = G__19909;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19899){
var G__19900 = cljs.core.first.call(null,seq19899);
var seq19899__$1 = cljs.core.next.call(null,seq19899);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19900,seq19899__$1);
});
...
var vec__19913 = cljs.core.split_with.call(null,(function (p1__19912_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19912_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19913,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19913,(1),null);
...
var vec__19919 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19919,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19919,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19922 = cljs.core.rest.call(null,remaining_tokens);
var G__19923 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19922;
name_tokens = G__19923;
continue;
} else {
...
var vec__19926 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19926,(0),null);
var arity = cljs.core.nth.call(null,vec__19926,(1),null);
var vec__19929 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19929,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19929,(1),null);
var vec__19932 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19932,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19932,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19932,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19932,(3),null);
...
var vec__19938 = result;
var munged_ns = cljs.core.nth.call(null,vec__19938,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19938,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19938,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19938,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19938,(4),null);
var arity = cljs.core.nth.call(null,vec__19938,(5),null);
...
var temp__5733__auto__ = devtools.munging.parse_fn_source.call(null,fn_source);
if(cljs.core.truth_(temp__5733__auto__)){
var vec__19942 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__19942,(0),null);
var args = cljs.core.nth.call(null,vec__19942,(1),null);
var vec__19945 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19945,(0),null);
var name = cljs.core.nth.call(null,vec__19945,(1),null);
...
var temp__5733__auto__ = cljs.core.get.call(null,state,prefix);
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__19948 = (arity + (1));
var G__19949 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
var temp__5733__auto__ = devtools.munging.get_fn_variadic_arity.call(null,f);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19950){
var vec__19951 = p__19950;
var arity = cljs.core.nth.call(null,vec__19951,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19951,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__4131__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__19954_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19955_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___19962 = arguments.length;
var i__4731__auto___19963 = (0);
while(true){
if((i__4731__auto___19963 < len__4730__auto___19962)){
args__4736__auto__.push((arguments[i__4731__auto___19963]));

var G__19964 = (i__4731__auto___19963 + (1));
i__4731__auto___19963 = G__19964;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19958){
var vec__19959 = p__19958;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19959,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19956){
var G__19957 = cljs.core.first.call(null,seq19956);
var seq19956__$1 = cljs.core.next.call(null,seq19956);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19957,seq19956__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__4131__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_.call(null,protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_.call(null,protocol_method))))?[(cljs.core.truth_((function (){var or__4131__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19967__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19967__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19967__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19967__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19968 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19968,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19968,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19968,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19968,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19968,(4),null);
var arity = cljs.core.nth.call(null,vec__19968,(5),null);
...
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.not.call(null,(function (){var and__4120__auto____$1 = silence_common_protocols_QMARK_;
...
var o__18966__auto__ = f;
return (o__18966__auto__["getBasis"]).call(o__18966__auto__);
});
/**
...
}catch (e19972){var _e__18973__auto__ = e19972;
...
var G__19973 = (obj[cljs.core.first.call(null,path)]);
var G__19974 = cljs.core.rest.call(null,path);
obj = G__19973;
path = G__19974;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.re_matches.call(null,/(.*)\$$/,key);
if(cljs.core.truth_(temp__5733__auto__)){
var m = temp__5733__auto__;
...
return (function (accum,p__19975){
var vec__19976 = p__19975;
var bit = cljs.core.nth.call(null,vec__19976,(0),null);
var protocol = cljs.core.nth.call(null,vec__19976,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19979){
var vec__19980 = p__19979;
var ns = cljs.core.nth.call(null,vec__19980,(0),null);
var name = cljs.core.nth.call(null,vec__19980,(1),null);
var selector = cljs.core.nth.call(null,vec__19980,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19985,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19985,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19985,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19983_SHARP_){
return (obj[cljs.core.first.call(null,p1__19983_SHARP_)]);
});})(name,sorted_matches,vec__19985,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
