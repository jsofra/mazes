...
var len__4730__auto___20019 = arguments.length;
var i__4731__auto___20020 = (0);
while(true){
if((i__4731__auto___20020 < len__4730__auto___20019)){
args__4736__auto__.push((arguments[i__4731__auto___20020]));

var G__20021 = (i__4731__auto___20020 + (1));
i__4731__auto___20020 = G__20021;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20016){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20017,G__20018,seq20016__$2);
});
...
var temp__5733__auto__ = cljs.core.first.call(null,cljs.core.first.call(null,group));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20022_SHARP_){
return (!((cljs.core.meta.call(null,p1__20022_SHARP_) == null)));
})))){
...
var map__20023 = opts;
var map__20023__$1 = (((((!((map__20023 == null))))?(((((map__20023.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20023.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20023):map__20023);
var markup_db = cljs.core.get.call(null,map__20023__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20027){var _e__18973__auto__ = e20027;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e20029){var _e__18973__auto__ = e20029;
return false;
}}
})())){
...
var temp__5733__auto__ = devtools.formatters.printing.build_markup.call(null,markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),obj);
if(cljs.core.truth_(temp__5733__auto__)){
...
var _STAR_current_state_STAR__orig_val__20031 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__20032 = devtools.formatters.state.get_current_state.call(null);
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__20032;

try{var map__20033 = opts;
var map__20033__$1 = (((((!((map__20033 == null))))?(((((map__20033.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20033.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20033):map__20033);
var markup_db = cljs.core.get.call(null,map__20033__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__20031;
}});
...
;
var temp__5733__auto___20038 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___20038)){
var managed_print_level_20039 = temp__5733__auto___20038;
var _STAR_print_level_STAR__orig_val__20036_20040 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__20037_20041 = managed_print_level_20039;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__20037_20041;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR__orig_val__20036_20040,_STAR_print_level_STAR__temp_val__20037_20041,managed_print_level_20039,temp__5733__auto___20038,writer,opts,job_fn){
return (function (p1__20035_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20035_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__20036_20040,_STAR_print_level_STAR__temp_val__20037_20041,managed_print_level_20039,temp__5733__auto___20038,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__20036_20040;
}} else {
job_fn.call(null);
}
